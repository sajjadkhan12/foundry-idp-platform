...
import { Users, Shield, Server, Settings, Activity, ArrowRight, Layers, Building2 } from 'lucide-react';
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg group-hover:bg-orange-50 dark:group-hover:bg-orange-900/20 transition-colors">
                                    <Building2 className="w-6 h-6 text-gray-600 dark:text-gray-400 group-hover:text-orange-600 dark:group-hover:text-orange-400" />
                                </div>
                                <div>
                                    <h3 className="font-medium text-gray-900 dark:text-white">Business Units</h3>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">Create and manage business units</p>
                                </div>
                            </div>
